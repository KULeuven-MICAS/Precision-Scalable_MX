...
module snax_MX_tensor_core_reqrspman_ReqRspManager(	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
  ...
  wire             _io_readWriteRegIO_valid_T = io_reqRspIO_req_bits_addr == 32'h3;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:86:32
  ...
  wire             _GEN_0 = _GEN < 33'h4;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:127:46, :129:29
    ...
    always @(posedge clock) begin	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:132:15
      if (writeReg & ~_GEN_0 & ~reset & (|remainingMask)) begin	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:83:40, :103:40, :129:{29,50}, :132:15, :133:16
        if (`ASSERT_VERBOSE_COND_)	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:132:15
          $error("Assertion failed: csr write address overflow! Address: %d, Max: 3, Config: %d\n    at ReqRspManager.scala:132 assert(\n",
  ...
  wire [31:0]      _GEN_2 = _GEN_1[io_reqRspIO_req_bits_addr[2:0]];	// <stdin>:107:43, src/main/scala/snax/reqRspManager/ReqRspManager.scala:170:33
  ...
  always @(posedge clock or posedge reset) begin	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
    if (reset) begin	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
      ...
      automatic logic [3:0][31:0] _GEN_3;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:130:55
      automatic logic [31:0]      _regs_T_6;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:130:64
      _GEN_3 = {{regs_3}, {regs_2}, {regs_1}, {regs_0}};	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :130:55
      _regs_T_6 =
        _GEN_3[io_reqRspIO_req_bits_addr[1:0]] & ~remainingMask
        | io_reqRspIO_req_bits_data & remainingMask;	// <stdin>:61:26, src/main/scala/snax/reqRspManager/ReqRspManager.scala:103:40, :130:{55,57,64,76}
      if (writeReg & _GEN_0 & io_reqRspIO_req_bits_addr[1:0] == 2'h0)	// <stdin>:58:21, src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :83:40, :102:18, :129:{29,50}, :130:30
        regs_0 <= _regs_T_6;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :130:64
      if (writeReg & _GEN_0 & io_reqRspIO_req_bits_addr[1:0] == 2'h1)	// <stdin>:58:21, src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :83:40, :102:18, :129:{29,50}, :130:30
        regs_1 <= _regs_T_6;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :130:64
      if (writeReg & _GEN_0 & io_reqRspIO_req_bits_addr[1:0] == 2'h2)	// <stdin>:58:21, src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :83:40, :102:18, :129:{29,50}, :130:30
        regs_2 <= _regs_T_6;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :130:64
      if (writeReg & _GEN_0 & (&(io_reqRspIO_req_bits_addr[1:0])))	// <stdin>:58:21, src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:21, :83:40, :102:18, :129:{29,50}, :130:30
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
    ...
    initial begin	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
      automatic logic [31:0] _RANDOM[0:5];	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
        ...
        readRegBusy = _RANDOM[3'h4][0];	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7, :144:28
        readRegBuffer = {_RANDOM[3'h4][31:1], _RANDOM[3'h5][0]};	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7, :144:28, :148:30
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:59:7
        regs_0 = 32'h0;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:{21,29}
        regs_1 = 32'h0;	// src/main/scala/snax/reqRspManager/ReqRspManager.scala:79:{21,29}
