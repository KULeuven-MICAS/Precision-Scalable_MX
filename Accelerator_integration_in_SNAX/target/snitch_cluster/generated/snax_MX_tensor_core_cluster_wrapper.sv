...
package snax_MX_tensor_core_cluster_pkg;
...
module snax_MX_tensor_core_cluster_wrapper (
  //-----------------------------
  // Clock and reset
  //-----------------------------
  input  logic                                   clk_i,
  ...
  // Observable pins
  //-----------------------------
  output logic [snax_MX_tensor_core_cluster_pkg::ObsWidth-1:0] obs_o,
  //-----------------------------
  // Interrupt ports
  //-----------------------------
  input  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] meip_i,
  input  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] mtip_i,
  input  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] msip_i,
  //-----------------------------
  ...
  // SRAM configurations
  //-----------------------------
  input  snax_MX_tensor_core_cluster_pkg::sram_cfgs_t         sram_cfgs_i,
  //-----------------------------
  // Narrow AXI ports
  //-----------------------------
  input  snax_MX_tensor_core_cluster_pkg::narrow_in_req_t     narrow_in_req_i,
  output snax_MX_tensor_core_cluster_pkg::narrow_in_resp_t    narrow_in_resp_o,
  output snax_MX_tensor_core_cluster_pkg::narrow_out_req_t    narrow_out_req_o,
  input  snax_MX_tensor_core_cluster_pkg::narrow_out_resp_t   narrow_out_resp_i,
  //-----------------------------
  //Wide AXI ports
  //-----------------------------
  output snax_MX_tensor_core_cluster_pkg::wide_out_req_t      wide_out_req_o,
  input  snax_MX_tensor_core_cluster_pkg::wide_out_resp_t     wide_out_resp_i,
  input  snax_MX_tensor_core_cluster_pkg::wide_in_req_t       wide_in_req_i,
  output snax_MX_tensor_core_cluster_pkg::wide_in_resp_t      wide_in_resp_o
);
  ...
  localparam int unsigned SnaxNarrowTcdmPorts     [2] = '{18, 0};
  localparam int unsigned SnaxWideTcdmPorts       [2] = '{0, 0};
  localparam int unsigned SnaxNarrowStartIdx      [1] = '{0};
  localparam int unsigned SnaxNarrowEndIdx        [1] = '{33};
  localparam int unsigned SnaxWideStartIdx        [1] = '{0};
  localparam int unsigned SnaxWideEndIdx          [1] = '{0};

  //-----------------------------
  // SNAX Custom Instruction Ports
  //-----------------------------
  // Request for custom instruction format
  snax_MX_tensor_core_cluster_pkg::acc_req_t [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] snax_req;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] snax_qvalid;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] snax_qready;
  // Response for custom instruction format
  snax_MX_tensor_core_cluster_pkg::acc_resp_t [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] snax_resp;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] snax_pvalid;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] snax_pready;

  //-----------------------------
  // SNAX CSR Ports
  //-----------------------------
  // Request for CSR format
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0][31:0] snax_csr_req_data;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0][31:0] snax_csr_req_addr;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0]       snax_csr_req_write;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0]       snax_csr_req_valid;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0]       snax_csr_req_ready;
  ///Response for CSR format
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0][31:0] snax_csr_rsp_data;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0]       snax_csr_rsp_valid;
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0]       snax_csr_rsp_ready;
    
  //-----------------------------
  // SNAX TCDM wires
  //-----------------------------
  snax_MX_tensor_core_cluster_pkg::tcdm_req_t [17:0] snax_tcdm_req;
  snax_MX_tensor_core_cluster_pkg::tcdm_rsp_t [17:0] snax_tcdm_rsp;

  //-----------------------------
  // SNAX Multiaccelerator MUX
  //-----------------------------
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0][31:0] multi_acc_mux;

  //-----------------------------
  // SNAX Barrier Wire
  //-----------------------------
  logic [snax_MX_tensor_core_cluster_pkg::NrCores-1:0] snax_barrier;
  ...
  snitch_cluster #(
    ...
    .NarrowDataWidth (64),
    .WideDataWidth (512),
    .NarrowIdWidthIn (snax_MX_tensor_core_cluster_pkg::NarrowIdWidthIn),
    .WideIdWidthIn (snax_MX_tensor_core_cluster_pkg::WideIdWidthIn),
    .NarrowUserWidth (snax_MX_tensor_core_cluster_pkg::NarrowUserWidth),
    .WideUserWidth (snax_MX_tensor_core_cluster_pkg::WideUserWidth),
    .narrow_in_req_t (snax_MX_tensor_core_cluster_pkg::narrow_in_req_t),
    .narrow_in_resp_t (snax_MX_tensor_core_cluster_pkg::narrow_in_resp_t),
    .narrow_out_req_t (snax_MX_tensor_core_cluster_pkg::narrow_out_req_t),
    .narrow_out_resp_t (snax_MX_tensor_core_cluster_pkg::narrow_out_resp_t),
    .wide_out_req_t (snax_MX_tensor_core_cluster_pkg::wide_out_req_t),
    .wide_out_resp_t (snax_MX_tensor_core_cluster_pkg::wide_out_resp_t),
    .wide_in_req_t (snax_MX_tensor_core_cluster_pkg::wide_in_req_t),
    .wide_in_resp_t (snax_MX_tensor_core_cluster_pkg::wide_in_resp_t),
    .NrHives (1),
    .NrCores (2),
    .TCDMDepth (snax_MX_tensor_core_cluster_pkg::TCDMDepth),
    .ClusterPeriphSize (64),
    .ClusterMMIOSize(16),
    .ClusterAddrSpace (4096),
    .NrBanks (snax_MX_tensor_core_cluster_pkg::NrBanks),
    .DMAAxiReqFifoDepth (16),
    .DMAReqFifoDepth (8),
    .ICacheLineWidth (snax_MX_tensor_core_cluster_pkg::ICacheLineWidth),
    .ICacheLineCount (snax_MX_tensor_core_cluster_pkg::ICacheLineCount),
    .ICacheSets (snax_MX_tensor_core_cluster_pkg::ICacheSets),
    .VMSupport (0),
    .RVE (2'b00),
    .RVF (2'b00),
    .RVD (2'b00),
    ...
    .TotalSnaxNarrowTcdmPorts(18),
    .TotalSnaxWideTcdmPorts(0),
    .SnaxUseCustomPorts (2'b00),
    .SnaxUseIdxTcdmAssign(1'b1),
    .SnaxNumNarrowAssignIdx(1),
    .SnaxNumWideAssignIdx(1),
    ...
    .FPUImplementation (snax_MX_tensor_core_cluster_pkg::FPUImplementation),
    .SnitchPMACfg (snax_MX_tensor_core_cluster_pkg::SnitchPMACfg),
    ...
    .Hive (snax_MX_tensor_core_cluster_pkg::Hive),
    ...
    .NarrowMaxMstTrans (4),
    .NarrowMaxSlvTrans (4),
    .sram_cfg_t (snax_MX_tensor_core_cluster_pkg::sram_cfg_t),
    .sram_cfgs_t (snax_MX_tensor_core_cluster_pkg::sram_cfgs_t),
    .ObsWidth (snax_MX_tensor_core_cluster_pkg::ObsWidth),
    .DebugSupport (0),
    .acc_req_t (snax_MX_tensor_core_cluster_pkg::acc_req_t),
    .acc_resp_t (snax_MX_tensor_core_cluster_pkg::acc_resp_t),
    .tcdm_req_t (snax_MX_tensor_core_cluster_pkg::tcdm_req_t),
    .tcdm_rsp_t (snax_MX_tensor_core_cluster_pkg::tcdm_rsp_t)
  ) i_cluster (
    //-----------------------------
    // Clock and reset
    //-----------------------------
  ...
  snax_MX_tensor_core_wrapper # (
    .DataWidth        ( snax_MX_tensor_core_cluster_pkg::NarrowDataWidth ),
    .SnaxTcdmPorts    ( 18 ),
    .tcdm_req_t       ( snax_MX_tensor_core_cluster_pkg::tcdm_req_t ),
    .tcdm_rsp_t       ( snax_MX_tensor_core_cluster_pkg::tcdm_rsp_t )
  ) i_snax_core_0_acc_0_snax_MX_tensor_core  (
    //-----------------------------
    // Clock and reset
    //-----------------------------
    .clk_i            ( clk_i  ),
